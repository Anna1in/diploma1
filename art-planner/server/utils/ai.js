...
async function analyzeArtWithGemini(base64Image, userPrompt) {
    ...
    **OUTPUT FORMAT (CRITICAL):**
    Ви ПОВИННІ повернути відповідь ВИКЛЮЧНО у форматі JSON без маркерів Markdown. Не малюйте зображення! Замість цього поверніть координати для ліній та точок, які фронтенд намалює поверх оригінального фото.
